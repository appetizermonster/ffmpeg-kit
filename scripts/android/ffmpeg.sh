...
./configure \
  ...
  --disable-vdpau \
  --disable-decoders \
  --enable-decoder=bintext,bmp,png,tiff,webp,zlib,aac,aac_fixed,aac_at,aac_latm,adpcm_4xm,adpcm_adx,adpcm_afc,adpcm_agm,adpcm_aica,adpcm_argo,adpcm_ct,adpcm_dtk,adpcm_ea,adpcm_ea_maxis_xa,adpcm_ea_r1,adpcm_ea_r2,adpcm_ea_r3,adpcm_ea_xas,g722,g726,g726le,adpcm_ima_alp,adpcm_ima_amv,adpcm_ima_apc,adpcm_ima_apm,adpcm_ima_cunning,adpcm_ima_dat4,adpcm_ima_dk3,adpcm_ima_dk4,adpcm_ima_ea_eacs,adpcm_ima_ea_sead,adpcm_ima_iss,adpcm_ima_moflex,adpcm_ima_mtf,adpcm_ima_oki,adpcm_ima_qt,adpcm_ima_qt_at,adpcm_ima_rad,adpcm_ima_smjpeg,adpcm_ima_ssi,adpcm_ima_wav,adpcm_ima_ws,adpcm_ms,adpcm_mtaf,adpcm_psx,adpcm_sbpro_2,adpcm_sbpro_3,adpcm_sbpro_4,adpcm_swf,adpcm_thp,adpcm_thp_le,adpcm_vima,adpcm_xa,adpcm_yamaha,adpcm_zork,alac,alac_at,amrnb,amr_nb_at,ape,flac,gremlin_dpcm,gsm,gsm_ms,gsm_ms_at,mp1,mp1float,mp1_at,mp2,mp2float,mp2_at,mp3float,mp3,mp3_at,mp3adufloat,mp3adu,mp3on4float,mp3on4,als,opus,libopus,pcm_alaw,pcm_alaw_at,pcm_bluray,pcm_dvd,pcm_f16le,pcm_f24le,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_lxf,pcm_mulaw,pcm_mulaw_at,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_sga,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_vidc,libspeex,vorbis,libvorbis,wavpack,ws_snd1,wmalossless,wmapro,wmav1,wmav2,wmavoice \
  --disable-encoders \
  --enable-encoder=bmp,gif,ljpeg,png,tiff,zlib,aac,aac_at,adpcm_adx,adpcm_argo,g722,g726,g726le,adpcm_ima_alp,adpcm_ima_amv,adpcm_ima_apm,adpcm_ima_qt,adpcm_ima_ssi,adpcm_ima_wav,adpcm_ms,adpcm_swf,adpcm_yamaha,flac,libmp3lame,opus,libopus,pcm_alaw,pcm_alaw_at,pcm_dvd,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_mulaw,pcm_mulaw_at,pcm_s16be,pcm_s16be_planar,pcm_s16le,pcm_s16le_planar,pcm_s24be,pcm_s24daud,pcm_s24le,pcm_s24le_planar,pcm_s32be,pcm_s32le,pcm_s32le_planar,pcm_s64be,pcm_s64le,pcm_s8,pcm_s8_planar,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,pcm_vidc,vorbis,libvorbis \
  --disable-demuxers \
  --enable-demuxer=aac,aiff,alaw,amr,amrnb,amrwb,ape,asf,asf_o,ast,bin,data,f32be,f32le,f64be,f64le,ffmetadata,flac,m4v,matroska,webm,mlv,mov,mp4,m4a,3gp,3g2,mj2,mp3,mpc,mpc8,mpeg,mpegts,mpegtsraw,mpegvideo,ogg,s16be,s16le,s24be,s24le,s32be,s32le,s337m,s8,u16be,u16le,u24be,u24le,u32be,u32le,u8,wav,xwma \
  --disable-muxers \
  --enable-muxer=f32be,f32le,f64be,f64le,ffmetadata,flac,m4v,matroska,mp3,mp4,mpeg,mpjpeg,mulaw,null,oga,ogg,ogv,opus,s16be,s16le,s24be,s24le,s32be,s32le,s8,singlejpeg,spx,tee,u16be,u16le,u24be,u24le,u32be,u32le,u8,wav,webp \
  --disable-protocols \
